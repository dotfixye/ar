    ...
    (a.fn.waitForImages = function() {
        ...
        if (
            (a.isPlainObject(arguments[0]) ?
                ...
                (c = c || a.noop),
                (d = d || a.noop),
                (e = !!e), !a.isFunction(c) || !a.isFunction(d))
        )
    ...
    (r.prototype.updateEntries = function(t) {
        ...
        return (
            ...
            (g.isFunction(this.settings.sort) ?
                ...
                this.resetFilters(i)),
            (this.entries = this.entries.concat(i)), !0
        );
    }),
    ...
    (r.prototype.init = function() {
        ...
        g.each(this.entries, function(t, i) {
                var e = g(i),
                    s = l.imgFromEntry(e);
                if (
                    (e.addClass("jg-entry"), !0 !== e.data("jg.loaded") && "skipped" !== e.data("jg.loaded"))
                )
                    if (
    ...
    (r.prototype.retrieveMaxRowHeight = function() {
        ...
        if ("string" === g.type(this.settings.maxRowHeight))
            ...
            if ("number" !== g.type(this.settings.maxRowHeight)) {
                if (!1 === this.settings.maxRowHeight ||
...
class GridToFullscreenEffect {
    constructor(e, n, t = {}) {
        ...
        (this.scene = null),
        (this.renderer = null),
        (t.scrollContainer = t.scrollContainer || null),
        (t.timing = t.timing || {}),
        (t.timing.type = t.timing.type || "sameEnd"),
        (t.timing.sections = t.timing.sections || 1),
        (t.timing.latestStart = t.timing.latestStart || 0.5),
        (t.timing.duration = t.timing.duration || 1),
        (t.transformation = t.transformation || {}),
        (t.transformation.type = t.transformation.type || "none"),
        (t.transformation.props = t.transformation.props || {}),
        (t.activation.type = t.activation.type || "topLeft"),
        (t.seed = t.seed || 0),
        (t.easings = t.easings || {}),
        (t.easings.toFullscreen = t.easings.toFullscreen || Power0.easeNone),
        (t.easings.toGrid = t.easings.toGrid || Power0.easeNone),
        (t.flipBeizerControls = t.flipBeizerControls || {}),
        (t.flipBeizerControls.c0 = t.flipBeizerControls.c0 || {}),
        (t.flipBeizerControls.c0.x = t.flipBeizerControls.c0.x || 0.5),
        (t.flipBeizerControls.c0.y = t.flipBeizerControls.c0.y || 0.5),
        (t.flipBeizerControls.c1 = t.flipBeizerControls.c1 || {}),
    ...
    createTextures(e) {
        ...
        for (let t = 0; t < e.length; t++) {
            ...
            (s.generateMipmaps = !1),
            (s.wrapS = s.wrapT = THREE.ClampToEdgeWrapping),
    ...
    setCurrentTextures() {
        ...
        (this.uniforms.uImage.value = e.small.texture),
        (this.uniforms.uImageRes.value.x = e.small.texture.image.naturalWidth),
        (this.uniforms.uImageRes.value.y = e.small.texture.image.naturalHeight),
        (this.uniforms.uImageLarge.value = e.large.texture),
        (this.uniforms.uImageLargeRes.value.x =
            e.large.texture.image.naturalWidth),
        (this.uniforms.uImageLargeRes.value.y =
            e.large.texture.image.naturalHeight),
    ...
    init() {
        ...
        (this.mesh = new THREE.Mesh(n, s)),
        this.scene.add(this.mesh),
            window.addEventListener("resize", this.onResize),
            this.options.scrollContainer &&
            this.options.scrollContainer.addEventListener("scroll", (e) => {
                this.recalculateUniforms(e);
            });
        for (let e = 0; e < this.itemsWrapper.children.length; e++) {
            this.itemsWrapper.children[e].children[0].addEventListener(
                "mousedown",
    ...
    recalculateUniforms(e) {
        ...
        (u.position.x = c),
        (u.position.y = m),
        (this.uniforms.uPlaneCenter.value.x = c / s),
        (this.uniforms.uPlaneCenter.value.y = m / o),
        (this.uniforms.uMeshScale.value.x = s),
        (this.uniforms.uMeshScale.value.y = o),
        (this.uniforms.uScaleToViewSize.value.x = i.width / s - 1),
        (this.uniforms.uScaleToViewSize.value.y = i.height / o - 1);
    }
    toFullscreen(e, n) {
        if (!this.isFullscreen && !this.isAnimating) {
            if (
                ((this.isAnimating = !0),
                    ...
                    this.recalculateUniforms(n),
                    this.textures[e])
            ) {
                const n = this.textures[e];
                (this.uniforms.uImage.value = n.small.texture),
                (this.uniforms.uImageRes.value.x =
                    n.small.texture.image.naturalWidth),
                (this.uniforms.uImageRes.value.y =
                    n.small.texture.image.naturalHeight),
                (this.uniforms.uImageLarge.value = n.large.texture),
                (this.uniforms.uImageLargeRes.value.x =
                    n.large.texture.image.naturalWidth),
                (this.uniforms.uImageLargeRes.value.y =
                    n.large.texture.image.naturalHeight);
            }
    ...
    onResize(e) {
        ...
        this.camera.updateProjectionMatrix(),
            this.renderer.setSize(window.innerWidth, window.innerHeight),
            this.currentImageIndex > -1 &&
            (this.recalculateUniforms(e), this.render());
    }
}
var activations = {
...
const transformations = {
    ...
    simplex: (e) => {
        ...
        let n = ensureFloat(e.amplitudeX || 0.5),
            t = ensureFloat(e.amplitudeY || 0.5),
            r = ensureFloat(e.frequencyX || 1),
            i = ensureFloat(e.frequencyY || 0.75),
            s = ensureFloat(e.progressLimit || 0.5);
    ...
    return (function(t) {
            ...
            t.exports = function(t, e) {
                ...
                if ((n = v ? r : y ? r[d] || c(d, {}) : (r[d] || {}).prototype))
                    for (f in e) {
                        if (
                            ((p = e[f]),
                                (l = t.noTargetGet ? (h = o(n, f)) && h.value : n[f]), !s(v ? f : d + (y ? "." : "#") + f, t.forced) && void 0 !== l)
                        ) {
                    ...
                    return function(h, d, v, y) {
                        for (
                            var m,
                                ...
                                O = 0,
                                _ = y || c,
                                E = e ? _(h, S) : n ? _(h, 0) : void 0; S > O; O++
                        )
        ...
        function(t, e, n) {
            ...
            t.exports = function(t) {
                ...
                if (
                    ...
                    for (
                        p = (l = b.call(d)).next, n = new v(); !(f = p.call(l)).done; x++
                    )
        ...
        function(t, e, n) {
            ...
            t.exports = !f ||
                ...
                function(t, e) {
                    for (
                        var n = a(t), o = arguments.length, f = 1, l = u.f, p = c.f; o > f;
                                ...
                                Object.defineProperty(this, n, {
                                    value: z.apply(
                                        ...
                                        (function() {
                                            ...
                                            for (e = 0; e < n; e++)
                                                for (
                                                    var i = arguments[e], u = 0, c = i.length; u < c; u++, o++
                                                )
                                                    r[o] = i[u];
                                            return r;
                                        })([o], t)
